...
def calculate_similarity_totals(args, model_type, stimuli_dir, n=-1, N=0):
    ...
    if args.bg_match:
        calculate_similarity_totals_bg_match(args, model_type, stimuli_dir, n=n, N=N)
        return
    elif args.random_bg:
        calculate_similarity_totals_random_bg(args, model_type, stimuli_dir, n=n, N=N)
        return
...
def calculate_similarity_totals_random_bg(args, model_type, stimuli_dir, n=-1, N=0):
    metrics = ['cos', 'dot', 'ed']
